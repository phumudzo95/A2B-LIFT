 ...
 */
export async function uploadLivenessPhoto(params) {
    const { sessionId, userId, rideId, photoBase64, mimeType = "image/jpeg", photoType, } = params;
    ...
    const storagePath = photoType === "cash_selfie"
 ...
 */
export async function getAdminSignedUrl(bucket, storagePath, expiresInSeconds = 3600) {
    try {

...
import { View, Text, StyleSheet, Pressable, TextInput, ActivityIndicator, Platform, Modal, FlatList, Alert, Linking, ScrollView, } from "react-native";
...
const VEHICLE_TYPES = [
    ...
    { id: "business", name: "Business Class", desc: "BMW 5 Series, Mercedes E Class", icon: "briefcase", pricePerKm: 40, baseFare: 150 },
    { id: "van", name: "Van", desc: "Hyundai H1, Mercedes Vito, Staria", icon: "bus", pricePerKm: 13, baseFare: 120 },
    { id: "luxury_van", name: "Luxury Van", desc: "Mercedes V Class", icon: "car", pricePerKm: 50, baseFare: 200 },
];
...
export default function ClientHomeScreen() {
    ...
    useEffect(() => {
        async function fetchOnlineDrivers() {
            try {
                ...
                const online = all
                    .filter((c) => c.isOnline && c.currentLat && c.currentLng)
                    .map((c) => ({ id: String(c.id), lat: Number(c.currentLat), lng: Number(c.currentLng) }));
    ...
    return (<View style={[styles.container, { paddingTop: insets.top + (Platform.OS === "web" ? 67 : 0) }]}>
      ...
      {rideStatus === "idle" && (<Animated.View entering={FadeInDown.duration(400)} style={styles.bottomSheet}>
      ...
      {rideStatus === "confirming" && (<Animated.View entering={FadeInDown.duration(400)} style={styles.confirmingSheet}>
          <View style={styles.sheetHandle}/>
          ...
          <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={[
            ...
            <View style={styles.priceCard}>
              ...
              {estimatedDistance && (<Text style={styles.distanceInfo}>{estimatedDistance} km estimated distance</Text>)}
            </View>
      ...
      {rideStatus === "requested" && (<Animated.View entering={FadeInDown.duration(400)} style={styles.searchingBottomSheet}>
          <View style={styles.sheetHandle}/>
      ...
      {rideStatus === "no_drivers" && (<Animated.View entering={FadeInDown.duration(400)} style={styles.bottomSheet}>
          <View style={styles.sheetHandle}/>
      ...
      {(rideStatus === "assigned" || rideStatus === "arriving" || rideStatus === "in_trip") && (<Animated.View entering={FadeInDown.duration(400)} style={styles.bottomSheet}>
          <View style={styles.sheetHandle}/>
      ...
      {rideStatus === "completed" && !showRating && (<Animated.View entering={FadeInDown.duration(400)} style={styles.bottomSheet}>
          <View style={styles.sheetHandle}/>
      ...
      {showRating && (<Animated.View entering={FadeInDown.duration(400)} style={styles.bottomSheet}>
          <View style={styles.sheetHandle}/>
          ...
          <View style={styles.commentContainer}>
            ...
            <TextInput style={styles.commentInput} placeholder="Share your experience..." placeholderTextColor={Colors.textMuted} value={ratingComment} onChangeText={setRatingComment} multiline numberOfLines={3} textAlignVertical="top"/>
          </View>

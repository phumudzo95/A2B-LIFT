    ...
    async function handleGoogleSignUp() {
        ...
        try {
            ...
            if (result.type === "success" && result.url) {
                ...
                if (token)
                    await AsyncStorage.setItem("a2b_token", token);
                setUser(user);
                router.replace("/role-select");
            }
        }
        ...
        <View style={styles.form}>
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={styles.inputWrapper}>
              ...
              <TextInput style={styles.input} placeholder="Choose a username" placeholderTextColor={Colors.textMuted} value={username} onChangeText={setUsername} autoCapitalize="none" autoCorrect={false}/>
            </View>
          </View>

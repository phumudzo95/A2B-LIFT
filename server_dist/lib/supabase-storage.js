...
const SUPABASE_URL = process.env.EXPO_PUBLIC_SUPABASE_URL || "https://zzwkieiktbhptvgsqerd.supabase.co";
 ...
 */
export async function uploadDocument(localUri, userId, docType) {
...
async function readUriAsBlob(uri) {
    ...
    if (!response.ok)
        throw new Error(`Cannot read file: ${uri}`);

...
export const HIGH_ACCURACY = Platform.select({
...
export function isRecentLocation(updatedAt, maxAgeMs = LOCATION_STALE_WINDOW_MS) {
    if (!updatedAt)
        return true;
...
export async function watchBestPosition(callback) {
    await enablePreciseLocationIfAvailable();

    ...
    return (<View style={styles.container}>
      ...
      <View style={[styles.content, { paddingTop: insets.top + (Platform.OS === "web" ? 67 : 0) }]}>
        ...
        <Animated.View entering={FadeInDown.duration(800).delay(600)} style={styles.bottomArea}>
          ...
          <Pressable style={({ pressed }) => [styles.primaryBtn, pressed && styles.btnPressed]} onPress={() => router.push("/login")}>
            <Text style={styles.primaryBtnText}>Get Started</Text>
            <Ionicons name="arrow-forward" size={20} color={Colors.primary}/>
          </Pressable>

          <Pressable style={({ pressed }) => [styles.secondaryBtn, pressed && { opacity: 0.6 }]} onPress={() => router.push("/register")}>
